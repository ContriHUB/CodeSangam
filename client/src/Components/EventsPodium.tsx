...
export default function EventsPodium({ teams }: Prop) {
    ...
    return (
        <div style={{ width: "100vw", height: "fit-content", opacity: topDivOpacity, overflow: "hidden" }}>
            <div className='events-podium h-[100vh]' style={{ position: "relative", width: "100vw", height: "fit-content" }}>
                ...
                <div className='events-podium-container flex flex-col'>
                ...
                </div>
                {
                    thirdTeam ? (
                        <div className='events-podium-container' style={{ display: "flex", flexDirection: "column" }}>
                            ...
                            <p style={{ color: "white" }}>{thirdTeam ? thirdTeam.name : ""}</p>
                        </div>
                    ) : (<></>)
                }
            </div>
